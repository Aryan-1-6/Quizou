...
class SubjectCreateView(CreateView):
    model = Subject
    fields = ('name', 'color')
    template_name = 'classroom/teachers/subject_add_form.html'

    def form_valid(self, form):
        subj = form.save(commit=False)
        subj.owner = self.request.user
        subj.save()
        messages.success(self.request, 'The subject was created with success! Go ahead and add some questions now.')
        return redirect('teachers:quiz_change_list')
